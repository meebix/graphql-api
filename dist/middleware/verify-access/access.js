...
function createAction(user, resource, paramsUuid) {
  ...
  return currentUser ? access.can(user.role).createOwn(resource) : access.can(user.role).createAny(resource);
}
...
function showAction(user, resource, paramsUuid) {
  ...
  return currentUser ? access.can(user.role).readOwn(resource) : access.can(user.role).readAny(resource);
}
...
function updateAction(user, resource, paramsUuid) {
  ...
  return currentUser ? access.can(user.role).updateOwn(resource) : access.can(user.role).updateAny(resource);
}
...
function destroyAction(user, resource, paramsUuid) {
  ...
  return currentUser ? access.can(user.role).deleteOwn(resource) : access.can(user.role).deleteAny(resource);
}
